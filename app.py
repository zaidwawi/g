...
class Artist(db.Model):
    ...
    facebook_link = db.Column(db.String(120))
    website = db.Column(db.String(120))
    seeking_talent = db.Column(db.Boolean, default = False)# nullable = False, default = False)
...
def create_artist_submission():
  ...
  try:
    ...
    artist = Artist(
                    ...
                    state=forms.city.data,
                    phone=forms.phone.data,
                    genres=forms.genres.data, 
                    image_link=forms.image_link.data,
                    facebook_link=forms.facebook_link.data
